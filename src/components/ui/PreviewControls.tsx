    ...
    <div className="mb-1 flex items-center justify-between border-b pb-1">
      <div className="flex items-center gap-1">
        <ToggleGroup 
          ...
          className="gap-0"
        >
          <ToggleGroupItem value="mobile" aria-label="Mobile view" size="sm" className="h-6 w-6 p-0">
            <Smartphone className="w-2.5 h-2.5" />
          </ToggleGroupItem>
          <ToggleGroupItem value="tablet" aria-label="Tablet view" size="sm" className="h-6 w-6 p-0">
            <Tablet className="w-2.5 h-2.5" />
          </ToggleGroupItem>
          <ToggleGroupItem value="desktop" aria-label="Desktop view" size="sm" className="h-6 w-6 p-0">
